    ...
    <div>
        ...
        <van-col span="23" offset="1">
            <div v-for="(v,i) in getcontent" :key="i" class="out">
                <h4>{{v.doctor.title}}</h4>
                <div class="inner">
                    <div class="content">
                    <van-image fit="fill" height="15" width="15" :src="v.doctor.img" />
                    <span class="span">{{v.doctor.name}}</span>
                    <span  class="span">{{v.doctor.hospital}}</span>
                    </div>
                    <div>
                        <span class="span">阅读{{v.doctor.red}}</span>
                        <span class="span">点赞{{v.doctor.like}}</span>
                    </div>
                </div>
